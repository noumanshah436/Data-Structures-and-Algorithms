...
//  the key point is that we have to control filepointer after writing to file 
...
// store record in file and then display in screen by using ofstrea and istream
/*
